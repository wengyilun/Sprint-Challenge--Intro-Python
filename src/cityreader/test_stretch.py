...
class CityreaderTests(unittest.TestCase):
  ...
  def test_cityreader_stretch_correctness(self):
    ...
    #######
    #
    # inp2 = cityreader_stretch(32, -120, 45, -100, self.cities)
    #
    # self.assertEqual(len(inp2), len(expected))
    #
    # for i in range(len(inp2)):
    #   self.assertTrue(check_city(inp2[i], expected[i]))
    ...
    inp2 = cityreader_stretch(40, -50, 12, -120, self.cities)

    for i in range(len(inp2)):
      self.assertTrue(check_city(inp2[i], expected2[i]))
